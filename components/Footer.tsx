      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 mb-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            {/* Social Icons can go here if you want them in the footer as well */}
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#about" className="flex items-center text-sm transition-colors duration-200 hover:text-yellow-400 font-secondary">
                  <ChevronRight className="w-4 h-4 mr-2" />
                  About Us
                </a>
              </li>
              <li>
                <a href="#services" className="flex items-center text-sm transition-colors duration-200 hover:text-yellow-400 font-secondary">
                  <ChevronRight className="w-4 h-4 mr-2" />
                  Our Services
                </a>
              </li>
              <li>
                <a href="#team" className="flex items-center text-sm transition-colors duration-200 hover:text-yellow-400 font-secondary">
                  <ChevronRight className="w-4 h-4 mr-2" />
                  Our Team
                </a>
              </li>
              <li>
                <a href="#contact" className="flex items-center text-sm transition-colors duration-200 hover:text-yellow-400 font-secondary">
                  <ChevronRight className="w-4 h-4 mr-2" />
                  Contact
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#drilling" className="flex items-center text-sm transition-colors duration-200 hover:text-yellow-400 font-secondary">
                  <ChevronRight className="w-4 h-4 mr-2" />
                  Drilling Rigs
                </a>
              </li>
              <li>
                <a href="#wireline" className="flex items-center text-sm transition-colors duration-200 hover:text-yellow-400 font-secondary">
                  <ChevronRight className="w-4 h-4 mr-2" />
                  Wireline Services
                </a>
              </li>
              <li>
                <a href="#pressure" className="flex items-center text-sm transition-colors duration-200 hover:text-yellow-400 font-secondary">
                  <ChevronRight className="w-4 h-4 mr-2" />
                  Pressure Pumping
                </a>
              </li>
